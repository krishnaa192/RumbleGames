...
<div
  ...
  style={{ border: "2px solid rgb(230 231 231)",marginTop:'25px',paddingTop:'5px',paddingBottom:'5px'}}
>
  <span className="nav-text" style={{marginRight: '0px',
  marginLeft: '21px'}}>{selectedLabel}</span>
